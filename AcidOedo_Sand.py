...
def stopLoad():
    ...
    # save simulation
    os.mkdir('../AcidOedo_Sand_data/'+O.tags['d.id'])
    shutil.copytree('data','../AcidOedo_Sand_data/'+O.tags['d.id']+'/data')
    shutil.copytree('plot','../AcidOedo_Sand_data/'+O.tags['d.id']+'/plot')
    shutil.copytree('save','../AcidOedo_Sand_data/'+O.tags['d.id']+'/save')
    shutil.copy('AcidOedo_Sand.py','../AcidOedo_Sand_data/'+O.tags['d.id']+'/AcidOedo_Sand.py')
    shutil.copy(O.tags['d.id']+'_report.txt','../AcidOedo_Sand_data/'+O.tags['d.id']+'/'+O.tags['d.id']+'_report.txt')
